---
title: "Using the Excel DataDictionary Template"
...
![](images/dictionary_sm.png)


`r emo::ji('exclamation')` **Essential Guidelines**

- Use a single header row
- One row per record, one column per piece of information
- Do not mix numbers and text
- Do not use colours or formatting to store information. Instead use a separate column. 
- All entries are case-sensitive

## Getting Started

Decide on your study inclusion criteria:

1. This will help you limit the number of patients you need to record data for.
1. Data validation rules can be set to ensure that patients meet inclusion criteria at time of entry.

Determine what information needs to be recorded:

1. What is your outcome?
1. What is your exposure?
1. What might potentially confound this relationship?

Your biostatistician will be happy to meet to help you decide what information is required for a good analysis.

## Data Dictionary 

Before you start to enter data, you need to set up a data dictionary.

This is a list of all the variables you will enter and the range or allowed values for the variables.

Fill in one row of the dictionary for each variable
...
- Must be unique
- Can not contain special characters or spaces, except for an underscore '_'
...
- for all other dates use the format `1-Jan-2023` to avoid ambiguity
...
- Do not store information for biostatistics in cell formatting or comments - these are not imported
- Hidden rows and columns are not hidden from statistical software, remove these before sending
...
**Note that some versions of Excel will change cell contents to red even when data meets the data validation rules. This is an Excel bug and 
